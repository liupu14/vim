...
filetype plugin indent on    " required syntax enable
"显示行号"
set number
" 隐藏滚动条"
set guioptions-=r
...
"python解释器路径"
"let g:ycm_path_to_python_interpreter='/Users/liupu/anaconda3/bin/python'
"是否开启语义补全"
"let g:ycm_seed_identifiers_with_syntax=1
"新建.sh,.python文件，自动插入文件头
...
func SetTitle()
	if &filetype == 'python'
		...
		call append(line(".")+2,"# Author: liupu")
		call append(line(".")+3,"# mail: lpgauss@163.com")
		call append(line(".")+4,"# Created Time: ".strftime("%c"))
		call append(line(".")+5,"#************************************************#")
		call append(line(".")+6,"")
	else 
		call setline(1,"# Creared Time: ".strftime("%c"))
	endif 
